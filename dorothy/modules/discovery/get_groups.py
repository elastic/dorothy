...
# Harvest information on all Okta groups

import logging.config

import click

from dorothy.core import list_groups, index_event
from dorothy.modules.discovery.discovery import discovery

LOGGER = logging.getLogger(__name__)
MODULE_DESCRIPTION = "Harvest information on all Okta groups"
TACTICS = ["Discovery"]


@discovery.subshell(name="get-groups")
@click.pass_context
def get_groups(ctx):
    """Harvest information on all Okta groups"""
